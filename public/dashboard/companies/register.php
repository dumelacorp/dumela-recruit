<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        if(isset($_POST['company_action']) && ($_POST['company_action']) == 'create') {
...
<h3>New Company</h3>
    <form method="post" enctype="multipart/form-data">
        <input type="hidden" name="company_action" value="create">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    <br>
                    <button type="submit" class="btn btn-info btn-block">Create Company</button>
                </div>
            </div>
        </div>
    </form>
